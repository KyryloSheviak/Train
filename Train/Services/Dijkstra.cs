...
namespace Train.Services
{
    ...
    public class Dijkstra
    {
        ...
        public ResultPath FindShortestPath(string startName, string finishName)
        {
        ...
        /// <returns>Кратчайший путь</returns>
        public ResultPath FindShortestPath(GraphVertex startVertex, GraphVertex finishVertex)
        {
            InitInfo();
